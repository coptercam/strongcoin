...
uint256 hashGenesisBlock("0x569421d4f632476f44a1796b88de0affa4245b32e677ee0b201e3f33b90ed0c7");
...
const string strMessageMagic = "StrongCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 30 * 60; // StrongCoin: 30min    
static const int64 nTargetSpacing = 1 * 24 * 60 * 60; // StrongCoin: 180 days
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal StrongCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StrongCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Suspected MH370 wreakage not located in Indian Ocean";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395429425;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087669902;
        ...
        assert(block.hashMerkleRoot == uint256("0xd0c869bdd65da8f0425cbfcc7b018a65308fff9bcd66ed0f830afae9118e019f"));
